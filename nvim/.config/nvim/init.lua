...
require 'rohan.options'
require 'rohan.keymaps'
require 'rohan.commands'
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader><c-m-p>', '<cmd>:Telescope projects<CR>', { desc = 'Go to projects picker' })
  ...
  {
    dir = '/home/rohan/.config/nvim/oceanicghost',
    priority = 1000,
  },
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader><c-e>', ':Triptych<CR>', { silent = true })
    end,
  },
